...
export const varianta1 = {
    ...
    E: [
      {
        ...
        raspunsExemplu: 'Suedia are densitate mică a populației datorită climei reci subpolare în nord, reliefului muntos al Alpilor Scandinaviei și suprafeței mari acoperite de păduri.',
    ...
    E: [
      {
        ...
        raspunsExemplu: 'Hidrocentralele sunt mai frecvente în regiunea montană deoarece râurile au debite mari, pante accentuate și văi adânci, ceea ce permite construirea barajelor.',
  ...
  subiectIII: {
    ...
    C: [
      {
        tip: 'completare',
        enuntInainte: '1. Modul de formare al Carpaților Orientali (Centrali):',
      ...
      {
        tip: 'completare',
        enuntInainte: '2. Un tip de rocă specific Carpaților Centrali:',
      ...
      {
        tip: 'completare',
        enuntInainte: '4. Un etaj climatic prezent în Carpați:',
        raspunsCorect: 'alpin',
      ...
      {
        tip: 'completare',
        enuntInainte: '5. Un râu care izvorăște sau străbate Carpații:',
    ...
    D: [
      {
        tip: 'calcul',
        enunt: '1. Calculați amplitudinea termică medie anuală (Iulie 15,2°C - Ianuarie 5,0°C)',
    ...
    E: [
      {
        tip: 'calcul',
        enunt: '1. Calculați populația totală a Ucrainei în 2000 (0-14: 8.570.000 + 15-64: 33.731.000 + 65+: 6.756.000)',
